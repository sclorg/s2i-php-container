PHP 8.4 container image
=======================

This container image includes PHP 8.4 as a [S2I](https://github.com/openshift/source-to-image) base image for your PHP 8.4 applications.
...
PHP 8.4 available as container is a base platform for
building and running various PHP 8.4 applications and frameworks.
...
Usage in OpenShift
------------------
In this example, we will assume that you are using the `ubi8/php-84` image, available via `php:8.4` imagestream tag in Openshift.

To build a simple [cakephp-sample-app](https://github.com/sclorg/cakephp-ex.git) application in Openshift:

```
oc new-app php:8.4~https://github.com/sclorg/cakephp-ex.git
```
...
```
podman pull ubi8/php-84
```

An UBI image `ubi8/php-84` is used in this example. This image is usable and freely redistributable under the terms of the UBI End User License Agreement (EULA). See more about UBI at [UBI FAQ](https://developers.redhat.com/articles/ubi-faq).
...
* **INCLUDE_PATH**
  ...
  * Default: .:/opt/app-root/src:/opt/rh/rh-php84/root/usr/share/pear (EL7)
